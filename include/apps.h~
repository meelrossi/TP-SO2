...
int peluqueria_main(int argc, char *argv[]);		// peluqueria.c
int events_main(int argc, char *argv[]);			// events.c
int disk_main(int argc, char *argv[]);				// disk.c
int test_main(int argc, char *argv[]);				// test.c
int kill_main(int argc, char *argv[]);				// kill.c
int ts_main(int argc, char *argv[]);				// ts.c
int paint_main(int argc, char *argv[]);				//paint.c
